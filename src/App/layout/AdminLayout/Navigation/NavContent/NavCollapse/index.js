    ...
    if (this.props.layout === "horizontal") {
      mainContent = (
        <li
          ...
          onMouseLeave={() =>
            this.props.onNavCollapseLeave(this.props.collapse.id, this.props.type)
          }
...
const mapStateToProps = (state) => {
  return {
    ...
    isTrigger: state.templateReducer.isTrigger,
  };
};
...
const mapDispatchToProps = (dispatch) => {
  return {
    onCollapseToggle: (id, type) =>
      dispatch({ type: actionTypes.COLLAPSE_TOGGLE, menu: { id: id, type: type } }),
