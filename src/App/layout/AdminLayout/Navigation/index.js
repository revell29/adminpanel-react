...
const mapStateToProps = (state) => {
  return {
    ...
    preLayout: state.templateReducer.preLayout,
    collapseMenu: state.templateReducer.collapseMenu,
    layoutType: state.templateReducer.layoutType,
    navBackColor: state.templateReducer.navBackColor,
    navBackImage: state.templateReducer.navBackImage,
    navIconColor: state.templateReducer.navIconColor,
    navBrandColor: state.templateReducer.navBrandColor,
    layout6Background: state.templateReducer.layout6Background,
    layout6BackSize: state.templateReducer.layout6BackSize,
    rtlLayout: state.templateReducer.rtlLayout,
    navFixedLayout: state.templateReducer.navFixedLayout,
    boxLayout: state.templateReducer.boxLayout,
    navDropdownIcon: state.templateReducer.navDropdownIcon,
    navListIcon: state.templateReducer.navListIcon,
    navActiveListColor: state.templateReducer.navActiveListColor,
    navListTitleColor: state.templateReducer.navListTitleColor,
    navListTitleHide: state.templateReducer.navListTitleHide,
  };
};
